...
echo "  $TARGET/.claude/commands/blueprint-reject.md"
echo "  $TARGET/.claude/commands/blueprint-signoff.md"
echo "  $TARGET/.claude/commands/blueprint-continue.md"
echo "  $TARGET/.claude/agents/*.md  (9 subagents)"
...
echo "  3. Review each intent/EV-*/INTENT.md and run: /blueprint-signoff EV-###"
echo "  4. Run:  /blueprint-continue"
